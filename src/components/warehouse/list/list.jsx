      ...
      <div className="warehouse-header">
        ...
        <div className="warehouse-list">
          <div className="warehouse-list__item" key={warehouse.id}>
            ...
            <div className="warehouse-list__item__address">
              {warehouseList.address}
            </div>
            <div className="warehouse-list__item__name">
              {warehouseList.contactName}
            </div>
            <div className="warehouse-list__item__group">
              <span className="warehouse-list__item__name">
                {warehouseList.contactPhone}
              </span>
              <span className="warehouse-list__item__email">
